...
class _FilterTab extends StatelessWidget {
  ...
  const _FilterTab({required this.label, required this.selected, required this.color, required this.onTap});
  @override
  Widget build(BuildContext context) {
...
class _PuzzleCard extends StatelessWidget {
  ...
  final bool isHard;
  final VoidCallback onTap;
  const _PuzzleCard({required this.index, required this.puzzle, required this.isEasy, required this.isHard, required this.onTap});
  @override
  Widget build(BuildContext context) {
    final diffColor = isEasy ? Colors.greenAccent : isHard ? Colors.redAccent : Colors.orangeAccent;
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Row(children: [
                  Text('${puzzle.rows}x${puzzle.cols}  |  조각 ${puzzle.pieceIds.length}개  |  ',
                    style: const TextStyle(color: Colors.white54, fontSize: 13),
                  ),
                  Text(diffLabel, style: TextStyle(color: diffColor, fontSize: 13)),
                ]),
              ],
            ),
            const Spacer(),
